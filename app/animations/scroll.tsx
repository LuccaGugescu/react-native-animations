...
import { StatusBar, FlatList, Image, Text, View, Dimensions, StyleSheet, TouchableOpacity, Easing, SafeAreaViewBase, SafeAreaView } from 'react-native';
import { faker } from '@faker-js/faker';
import Animated, { Extrapolation, interpolate, useAnimatedRef, useAnimatedScrollHandler, useAnimatedStyle, useScrollViewOffset, useSharedValue } from 'react-native-reanimated';
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <Animated.FlatList
                ...
                renderItem={item => {
                    return (
                        <Animated.View style={{ transform: [{ scale: scrollHandler }] }} className='flex flex-row items-center m-4 p-4 bg-gray-200 rounded-2xl shadow-lg shadow-black'>
